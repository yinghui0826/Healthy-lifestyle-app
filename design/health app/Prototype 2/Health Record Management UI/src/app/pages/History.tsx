...
export function History() {
  ...
  const [filter, setFilter] = useState<"all" | "activity" | "diet">("all");
    ...
    <div className="px-6 py-6 max-w-3xl mx-auto">
      ...
      <div className="flex gap-3 mb-5">
        ...
        <div className="flex gap-1 bg-white border border-gray-200 rounded-xl p-1">
          {(["all", "activity", "diet"] as const).map(f => (
            <button
              key={f}
              onClick={() => setFilter(f)}
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden divide-y divide-gray-50">
                {grouped[date].map(r => (
                  <div key={r.id}>
                    ...
                    >
                      <div className={`w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 ${r.type === "activity" ? "bg-emerald-50" : "bg-blue-50"}`}>
                        {r.type === "activity"
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="text-sm text-gray-800 truncate">
                          {r instanceof ActivityRecord ? r.activityName : (r as DietRecord).mealName}
                        </div>
