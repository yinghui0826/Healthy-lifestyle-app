...
import { HealthRecordManager, ActivityRecord, DietRecord } from "../models/HealthRecord";

interface HealthContextType {
  manager: HealthRecordManager;
  records: (ActivityRecord | DietRecord)[];
  refresh: () => void;
}

const manager = new HealthRecordManager();
...
export function HealthProvider({ children }: { children: React.ReactNode }) {
  const [records, setRecords] = useState<(ActivityRecord | DietRecord)[]>(manager.getAll());
