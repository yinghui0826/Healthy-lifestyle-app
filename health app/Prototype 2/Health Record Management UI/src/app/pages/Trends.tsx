...
import { TrendingUp, Footprints, Flame, Droplets, UtensilsCrossed } from "lucide-react";
...
export function Trends() {
  ...
  const hasData = manager.getAll().length > 0;
          ...
          <ChartCard title="Water Intake (7 Days)">
            <ResponsiveContainer width="100%" height={180}>
              <AreaChart data={weekData} margin={{ top: 4, right: 10, bottom: 0, left: -10 }}>
                ...
                <XAxis dataKey="day" tick={{ fontSize: 11 }} tickLine={false} axisLine={false} />
                <YAxis tick={{ fontSize: 11 }} tickLine={false} axisLine={false} />
                <Tooltip contentStyle={{ borderRadius: "10px", border: "1px solid #e5e7eb", fontSize: "12px" }} formatter={(v: number) => [`${v} ml`, "Water"]} />
